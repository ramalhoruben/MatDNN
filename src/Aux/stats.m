%As in: http://www.mathworks.com/matlabcentral/fileexchange/46035-confusion-matrix--accuracy--precision--specificity--sensitivity--recall--f-score/content/confusionmatStats.m
%Edited by Ruben Ramalho, 2015
...
field8 = 'ExactMatch'; value8 = sum(group == grouphat)/length(group);
